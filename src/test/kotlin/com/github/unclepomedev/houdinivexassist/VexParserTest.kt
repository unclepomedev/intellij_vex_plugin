...
class VexParserTest : VexTestBase() {
    ...
    fun testBitwiseAndShiftOperators() {
        ...
        val cDecl =
            PsiTreeUtil.findChildrenOfType(
                    file,
                    com.github.unclepomedev.houdinivexassist.psi.VexDeclarationStatement::class
                        .java,
                )
        ...
        val notExpr =
            PsiTreeUtil.getChildOfType(
                xorExpr,
                com.github.unclepomedev.houdinivexassist.psi.VexPrefixExpr::class.java,
            )
    ...
    fun testEmptyDictLiteral() {
        ...
        val dictLiterals =
            PsiTreeUtil.findChildrenOfType(
                file,
                com.github.unclepomedev.houdinivexassist.psi.VexDictLiteral::class.java,
            )
        ...
        val vectorLiterals =
            PsiTreeUtil.findChildrenOfType(
                file,
                com.github.unclepomedev.houdinivexassist.psi.VexVectorLiteral::class.java,
            )
    ...
    fun testBasicContextDef() {
        ...
        val contextDefs =
            PsiTreeUtil.findChildrenOfType(
                file,
                com.github.unclepomedev.houdinivexassist.psi.VexContextDef::class.java,
            )
    ...
    fun testSimpleArrayAccess() {
        ...
        val errorMsg = errors.joinToString {
            (it as com.intellij.psi.PsiErrorElement).errorDescription
        }
        assertFalse(
            "Simple array access should parse without errors: $errorMsg",
            errors.isNotEmpty(),
        )
        val arrayAccess =
            PsiTreeUtil.findChildOfType(
    ...
    fun testModuloInArrayIndexMinimal() {
        ...
        assertFalse(
            "Minimal modulo in array index should parse without errors: $errorMsg",
            errors.isNotEmpty(),
        )
        val arrayAccess =
            PsiTreeUtil.findChildOfType(
    ...
    fun testModuloInArrayIndexParsesCorrectly() {
        ...
        assertEquals(
            "Expected exactly 2 array accesses in the test function",
            2,
            arrayAccesses.size,
        )
    ...
    fun testAddInArrayIndex() {
        ...
        val file = myFixture.configureByText(VexFileType, code)
        assertFalse(
            "Add operator in array index should parse without errors",
            PsiTreeUtil.hasErrorElements(file),
        )
    }
    ...
    fun testSubtractInArrayIndex() {
        ...
        val file = myFixture.configureByText(VexFileType, code)
        assertFalse(
            "Subtract operator in array index should parse without errors",
            PsiTreeUtil.hasErrorElements(file),
        )
    }
    ...
    fun testMultiplyInArrayIndex() {
        ...
        val file = myFixture.configureByText(VexFileType, code)
        assertFalse(
            "Multiply operator in array index should parse without errors",
            PsiTreeUtil.hasErrorElements(file),
        )
    }
    ...
    fun testDivideInArrayIndex() {
        ...
        val file = myFixture.configureByText(VexFileType, code)
        assertFalse(
            "Divide operator in array index should parse without errors",
            PsiTreeUtil.hasErrorElements(file),
        )
    }
    ...
    fun testBitwiseAndInArrayIndex() {
        ...
        val file = myFixture.configureByText(VexFileType, code)
        assertFalse(
            "Bitwise AND in array index should parse without errors",
            PsiTreeUtil.hasErrorElements(file),
        )
    }
    ...
    fun testBitwiseOrInArrayIndex() {
        ...
        val file = myFixture.configureByText(VexFileType, code)
        assertFalse(
            "Bitwise OR in array index should parse without errors",
            PsiTreeUtil.hasErrorElements(file),
        )
    }
    ...
    fun testBitwiseXorInArrayIndex() {
        ...
        val file = myFixture.configureByText(VexFileType, code)
        assertFalse(
            "Bitwise XOR in array index should parse without errors",
            PsiTreeUtil.hasErrorElements(file),
        )
    }
    ...
    fun testLeftShiftInArrayIndex() {
        ...
        val file = myFixture.configureByText(VexFileType, code)
        assertFalse(
            "Left shift in array index should parse without errors",
            PsiTreeUtil.hasErrorElements(file),
        )
    }
    ...
    fun testRightShiftInArrayIndex() {
        ...
        val file = myFixture.configureByText(VexFileType, code)
        assertFalse(
            "Right shift in array index should parse without errors",
            PsiTreeUtil.hasErrorElements(file),
        )
    }
    ...
    fun testEqualityInArrayIndex() {
        ...
        val file = myFixture.configureByText(VexFileType, code)
        assertFalse(
            "Equality operator in array index should parse without errors",
            PsiTreeUtil.hasErrorElements(file),
        )
    }
    ...
    fun testLogicalAndInArrayIndex() {
        ...
        val file = myFixture.configureByText(VexFileType, code)
        assertFalse(
            "Logical AND in array index should parse without errors",
            PsiTreeUtil.hasErrorElements(file),
        )
    }
    ...
    fun testLogicalOrInArrayIndex() {
        ...
        val file = myFixture.configureByText(VexFileType, code)
        assertFalse(
            "Logical OR in array index should parse without errors",
            PsiTreeUtil.hasErrorElements(file),
        )
    }
    ...
    fun testTernaryInArrayIndex() {
        ...
        val file = myFixture.configureByText(VexFileType, code)
        assertFalse(
            "Ternary operator in array index should parse without errors",
            PsiTreeUtil.hasErrorElements(file),
        )
    }
    ...
    fun testComplexExprInArrayIndex() {
        ...
        val file = myFixture.configureByText(VexFileType, code)
        assertFalse(
            "Complex expression in array index should parse without errors",
            PsiTreeUtil.hasErrorElements(file),
        )
    }
